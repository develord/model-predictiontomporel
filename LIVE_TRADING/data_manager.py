                    ...
                    async for message in ws:
                        try:
                            ...
                            if is_closed:
                                ...
                                # Double check DISABLED: 4h candle at 08:00 UTC was triggering
                                # on_daily_close() with incomplete daily data, causing false signals.
                                # Models are trained on closed 1D candles only.
