...
# Train meta on 2020-2025H1, validate on 2025H2 (2026 = true out-of-sample)
META_TRAIN_START = '2020-01-01'
META_TRAIN_END = '2025-09-30'
META_VAL_START = '2025-10-01'
...
def train_meta():
    logger.info(f"\n{'='*70}")
    logger.info(f"BTC META-MODEL XGBOOST TRAINING")
    logger.info(f"{'='*70}\n")

    # Load CNN models
    long_model, long_seq, long_ckpt = load_cnn_model(LONG_MODEL_DIR, 'BTC_direction_model.pt')
    short_model, short_seq, short_ckpt = load_cnn_model(SHORT_MODEL_DIR, 'BTC_short_model.pt')
