# ETH Production Trading System

Complete XGBoost-based trading system for Ethereum with intelligent signal filtering.
...
│   ├── eth_1d_data.csv
│   ├── eth_1w_data.csv
│   └── eth_multi_tf_merged.csv
├── models/                      # Trained models
│   ├── eth_v11_top50.joblib     # Final XGBoost model
│   ├── eth_v11_features.json    # Feature list
│   └── eth_v11_top50_stats.json # Training stats
├── results/                     # Backtest results
│   ├── eth_backtest_trades.csv
│   └── eth_backtest_summary.json
└── README.md                    # This file
```
...
- Backtest uses walk-forward methodology (no lookahead bias)
