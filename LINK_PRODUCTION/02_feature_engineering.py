"""
LINK Feature Engineering Script - Multi-Timeframe + Non-Technical
================================================================
Creates enriched features:
- Multi-TF technical indicators (4h, 1d, 1w) like BTC/ETH
- Cross-timeframe alignment signals
- Non-technical features (volatility regimes, momentum coherence)
- Market microstructure features
- Market regime features (bull/bear/range detection)
...
def build_features():
    ...
    logger.info(f"\n{'='*70}")
    logger.info(f"LINK MULTI-TF FEATURE ENGINEERING")
    logger.info(f"{'='*70}\n")
    ...
    # Save merged data
    output_file = DATA_DIR / 'link_features.csv'
