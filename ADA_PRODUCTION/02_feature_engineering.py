"""
ADA Feature Engineering Script V3 - Multi-Timeframe + Market Regime
================================================================
...
- Market regime features (126 features total)
- ATR-adaptive labeling (symmetric TP/SL)
...
def build_features():
    ...
    logger.info(f"\n{'='*70}")
    logger.info(f"ADA MULTI-TF FEATURE ENGINEERING")
    logger.info(f"{'='*70}\n")
    ...
    # Save merged data
    output_file = DATA_DIR / 'ada_features.csv'
